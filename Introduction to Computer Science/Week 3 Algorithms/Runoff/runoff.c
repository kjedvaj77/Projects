...
bool vote(int voter, int rank, string name)
{
    ...
    return false; //will see on check50 how it goes
}
...
void tabulate(void)
{
    ...
    for (int i = 0; i < voter_count; i++)
    {
        for (int j = 0; j < candidate_count; j++)
        {
            int index = preferences[i][j]; //gives us index of candidate
...
{
    // TODO
    // if any candidate have more then 50% of votes return true
